...
use App\Http\Controllers\SprintPayController;
...
// SprintPay Routes
Route::post('/sprintpay/webhook', [SprintPayController::class, 'webhook'])->name('sprintpay.webhook');
Route::any('e-fund', [SprintPayController::class, 'e_fund']);
Route::any('e-check', [SprintPayController::class, 'e_check']);
Route::any('verify', [SprintPayController::class, 'verify_username']);