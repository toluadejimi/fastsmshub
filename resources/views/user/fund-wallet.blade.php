...
<div class="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12" x-data="{ activeTab: '{{ $paystackEnabled ? 'paystack' : ($flutterwaveEnabled ? 'flutterwave' : ($sprintpayEnabled ? 'sprintpay' : 'manual')) }}' }">
