            ...
            <div class="p-5 grid md:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-wrap gap-6">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="sprintpay_enabled" value="1"
                                class="form-checkbox h-4 w-4 text-violet-600 rounded"
                ...
                <div class="md:col-span-3 border-t border-gray-100 pt-4">
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-3">
                            <h3 class="text-xs font-bold text-gray-500 uppercase tracking-widest flex items-center gap-1.5">
                                <span class="w-2 h-2 rounded-full bg-violet-500 inline-block"></span>SprintPay
                            </h3>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">API Key</label>
                                <input type="text" name="sprintpay_api_key" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-violet-400 focus:border-violet-400"
                                    value="{{ $sprintpayApiKey }}">
                            </div>
                        </div>
